...
std::pair<std::vector<std::string>, std::vector<std::string>>  TwoXor::addAsmStub(const std::vector<byte>& payload)
{
    ...
    code.emplace_back("start:");
    code.emplace_back("encode_setup:");

    code.emplace_back("jmp short call_decoder");
    code.emplace_back("decoder:");
    code.emplace_back("pop rsi");


    code.emplace_back("xor rcx, rcx");


//    code.emplace_back("mov rsi, payload");

//    code.emplace_back("push payload");
//    code.emplace_back("pop rsi");

//    code.emplace_back("call next");
//    code.emplace_back("next:");
//    code.emplace_back("pop rsi");
//    code.emplace_back("add rsi, 0x60");

//    code.emplace_back("lea rsi, [rip]");
//    code.emplace_back("add rsi, 0x60");
...
*/
    code.emplace_back("push len");
    code.emplace_back("pop r8");
...
//    code.emplace_back("jmp end_of_variant"); что бы избежать нуля на нулевом прыжке
...
//    code.emplace_back("mov rdx, len");
    ...
    code.emplace_back("xor al, keys.xor1");
    code.emplace_back("mov byte [rsi+rcx], al");
//    code.emplace_back("jmp end_of_cycle"); что бы избежать нуля на нулевом прыжке
    code.emplace_back("end_of_cycle:");
    code.emplace_back("inc rcx");
    code.emplace_back("cmp rcx, r8");
    code.emplace_back("jne encode");
    code.emplace_back("jmp rsi");



    code.emplace_back("call_decoder:");
    code.emplace_back("call decoder");
